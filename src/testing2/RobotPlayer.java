  ...
  public static void run(RobotController rc) throws GameActionException {
    ...
    while (true) {
      ...
      try {
        ...
        Utilities.fight(rc);
        Utilities.heal(rc);
        Direction d = Utilities.bugNav(rc, destination);
        if(d!=null)
          Utilities.tryMoveWithFill(d,rc);

        rc.setIndicatorString("Total damage dealt: "+rc.readSharedArray(1)+", total damage healed: "+rc.readSharedArray(2));
